          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="javascript:void(0)" class="nav-link" style="border-radius: 50px; background-color: #34A853;">
                ...
                <P><i>PERDIEM PANEL</i></P>
              </a>
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{route('request')}}" class="nav-link" style="border-radius: 50px; background-color: #0F7DC2;">
                    &nbsp;&nbsp;&nbsp;<i class="fas fa-graduation-cap mr-2"></i>
                    <p><i>Request Perdiem</i></p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{route('process')}}" class="nav-link" style="border-radius: 50px; background-color: #0F7DC2;">
                    &nbsp;&nbsp;&nbsp;<i class="fas fa-graduation-cap mr-2"></i>
                    <p><i>Process Perdiem</i></p>
                  </a>
                </li>
              </ul>
            </li>
