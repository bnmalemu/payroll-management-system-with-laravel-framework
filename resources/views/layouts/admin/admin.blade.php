    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{url('/dashboard')}}" class="brand-link" style="border-radius: 50px;">
          ...
          <span class="brand-text font-weight-light"><strong>BHU STATUS</strong></span>
        </a>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{route('admin.add_college.create')}}" class="nav-link" style="border-radius: 50px; background-color: #0F7DC2;">
                    &nbsp;&nbsp;&nbsp;<i class="fas fa-graduation-cap mr-2"></i>
                    <p><i>College</i></p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{route('admin.add_department.create')}}" class="nav-link" style="border-radius: 50px; background-color: #0F7DC2;">
                    &nbsp;&nbsp;&nbsp;<i class="fas fa-graduation-cap mr-2"></i>
                    <p><i>Department</i></p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{route('register_new_user')}}" class="nav-link" style="border-radius: 50px; background-color: #0F7DC2;">                 
                    &nbsp;&nbsp;&nbsp;<i class="fas fa-graduation-cap mr-2"></i>
                    <p><i>User</i></p>
                  </a>
                </li>
      ...
      <div class="content-wrapper" style="background-image: url(public/bna/3.jpg)">
        <!-- Main content -->
        @yield('content')
      </div>
      <!-- /.content-wrapper -->
