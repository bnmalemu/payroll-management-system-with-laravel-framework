...
<!-- Main content -->
  <section class="content">
    <!-- Start add user -->
    <div class="modal fade" id="add_user" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-keyboard="false" data-backdrop="static">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                <select name="role_id" class="form-control" style="border-radius: 50px;">
                  ...
                  <option value="payroll"><i>Payroll</i></option>
                  <option value="perdiem"><i>Perdiem</i></option>
                  <option value="budgetcontrol"><i>Budget Controll</i></option>
                  <option value="findirec"><i>Finance Director</i></option>
                </select>
              </div>
            </div>
    ...
    <!-- End of add user -->
    <!-- Start delete user -->
    <div class="modal fade" id="delete_user" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-keyboard="false" data-backdrop="static">
      <div class="modal-dialog modal-dialog-centered" role="document">
