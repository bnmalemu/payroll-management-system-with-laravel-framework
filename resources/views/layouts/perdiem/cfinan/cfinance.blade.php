    ...
    <div class="sidebar">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <br>
          <li class="nav-item">
            <a href=" {{ route('perdiem.col_fin_process_request.create') }} " class="nav-link">
          ...
          <li class="nav-item">
            <a href=" {{ route('perdiem.col_fin_prepare_abell.create') }} " class="nav-link">
              <i class="fas fa-money-bill-wave mr-2"></i>
              <p>
                አበል መጠየቂያ ቅጽ
              </p>
          ...
          <li class="nav-item">
            <a href=" {{ route('perdiem.col_fin_abell_mawerareja.create') }} " class="nav-link">
              <i class="fas fa-money-bill-wave mr-2"></i>
              <p>
                አበል ማወራረጃ ቅጽ
              </p>
