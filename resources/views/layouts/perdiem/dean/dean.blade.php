    ...
    <div class="sidebar">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <br>
          <li class="nav-item">
            <a href=" {{ route('perdiem.col_dean_process_request.create') }} " class="nav-link">
          ...
          <li class="nav-item">
            <a href=" {{ route('perdiem.col_dean_guzo_abell.create') }} " class="nav-link">
          ...
          <li class="nav-item">
            <a href=" {{ route('perdiem.col_dean_gizyi_abell.create') }} " class="nav-link">
              <i class="fas fa-money-bill-wave mr-2"></i>
              <p>
                የግዥ አበል መጠየቂያ
              </p>
