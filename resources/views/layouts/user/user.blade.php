...
<div class="wrapper">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href=" {{ route('admin.notification') }} " class="dropdown-item">
            <i class="fas fa-envelope mr-3"></i> <i>Notification</i>
          </a>
          <div class="dropdown-divider"></div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="" class="nav-link">
                  <i class="nav-icon far fa-circle text-success mr-2"></i>
                  <p class="text"><i>Write Comment</i></p>
                </a>
              </li>
              <li class="nav-item">
                <a href="" class="nav-link">
                  <i class="nav-icon far fa-circle text-success mr-2"></i>
                  <p class="text"><i>Read Comment</i></p>
                </a>
              </li>
              </ul>
            </li>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; <?php echo "".date('Y'); ?> <a>Developed by Biniyam A. (Lecturer)</a>.</strong>
    All rights reserved.
